...
public class LiteWebView extends WebView {
    ...
    private com.link.advertising.widget.SimpleWebChromeClient mWebChromeClient;
...
//        settings.setUserAgentString(userAgent + SDKContants.USER_AGENT);
        ...
        mWebChromeClient = new com.link.advertising.widget.SimpleWebChromeClient();
...
//            }
    ...
    public void setChromeClientCallback(com.link.advertising.widget.SimpleWebChromeClient.OnProgressCallback onProgressCallback) {
